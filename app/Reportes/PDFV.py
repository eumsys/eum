...
def main (argv):
    ...
    pdfResumenBoletaje = PDF('Resumen Boletaje Vespertino',datetime_vespertino_hoy_inicio,datetime_vespertino_hoy_fin,'')
    pdfAclaraciones = PDF('Aclaraciones',datetime_vespertino_ayer_inicio,datetime_vespertino_ayer_fin,'')
