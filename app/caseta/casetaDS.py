...
def leerArchivo():
	global habilitaMonedero,segundoCosto,contador,cobroIniciado,tolerancia,pagado,preguntarPorEstado,leido,fo,pe,fe,hh,hsalida,kill,killer,killbill,config,fechaAMD,nivelDeCambio,h,nivelActual,aux_tarifa,aux_tarifa2,imprime,NoCajero,tarifaSeleccionada,mostrarTiempoDeSalidaRestante,mensajeBoletoPerdido,mensajeBoletoUsado,tarifasAplicadas,mensajeTolerancia
	A=0
	#result=0
	while(kill == 0):
		#if(imprime==1):
