...
def configSocket(operacion,mensaje):
	...
	elif(operacion=='log inicial'):
		resultado = logInicial(s,'log inicial',mensaje)
	elif(operacion=='log final'):
		resultado = logInicial(s,'log final',mensaje)
	elif(operacion=='registro boleto'):
		resultado = registroBoleto(s,operacion)
	else:
		resultado = log(s,operacion,mensaje)
	return resultado
