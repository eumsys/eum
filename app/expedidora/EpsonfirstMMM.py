...
class Ui_ventanaAcceso(QDialog):
	...
	def setConfig(self):
		...
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols.txt", 'w')
		c=infile.write(str(""))
		c=infile.write(str(pol))
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols1.txt", 'w')
		c=infile.write(str(pol1))
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols2.txt", 'w')
		c=infile.write(str(pol2))
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols3.txt", 'w')
		c=infile.write(str(pol3))
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols4.txt", 'w')
		c=infile.write(str(pol4))
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols5.txt", 'w')
	...
	def panelConfig(self):
		...
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols.txt", 'r')
		c=infile.read()
		pol=str(c)
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols1.txt", 'r')
		c=infile.read()
		pol1=str(c)
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols2.txt", 'r')
		c=infile.read()
		pol2=str(c)
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols3.txt", 'r')
		c=infile.read()
		pol3=str(c)
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols4.txt", 'r')
		c=infile.read()
		pol4=str(c)
		infile.close()
		infile = open("/home/pi/Documents/eum/app/expedidora/datos/Epsonpols5.txt", 'r')
		c=infile.read()
		pol5=str(c)
		infile.close()
		self.lusu.setText('')
...
def hilos():
	...
	thread2 = Thread(target = leerTecla, args=())
	try:
		thread2.start()
		thread.start()
		thread1.start()
