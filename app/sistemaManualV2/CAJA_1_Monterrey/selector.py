...
if __name__ == "__main__":
	...
	#conf1 = 0 and conf2 = 0
	if(config1==False and config2==False ):			#  Expedidora
		os.system("sudo python3 /home/pi/Documents/eum/app/expedidora/first.py")
	#conf1 = 0 and conf2 = 1
	elif(config1==False and config2==True):			# Salida
		os.system("sudo python3 /home/pi/Documents/eum/app/salida/salida.py")
	#conf1 = 1 and conf2 = 0
	elif(config1==True and config2==False):			# Kiosco
		os.system("sudo python3 /home/pi/Documents/eum/app/Kiosco/main.py")
	#conf1 = 1 and conf2 = 1
	elif(config1==True and config2==True ):			# Numero de serie
		print("Agregar interfaz de numero de serie")
	GPIO.cleanup()
'''
