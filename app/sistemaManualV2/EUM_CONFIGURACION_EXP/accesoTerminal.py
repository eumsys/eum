...
class dAccesoConfigurarTerminal(object):
    ...
    def retranslateUi(self, dAccesoConfigurarTerminal):
        ...
        self.comboBox.setItemText(2, _translate("dAccesoConfigurarTerminal", "Configurar Apagar equipo", None))
        self.comboBox.setItemText(3, _translate("dAccesoConfigurarTerminal", "Configurar Fecha-Hora", None))
        self.comboBox.setItemText(4, _translate("dAccesoConfigurarTerminal", "Serie y Modelo", None))
        self.comboBox.setItemText(5, _translate("dAccesoConfigurarTerminal", "APAGAR EQUIPO", None))
        #Agregado
