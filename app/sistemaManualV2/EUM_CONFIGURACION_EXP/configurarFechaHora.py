...
"   }"))
    ...
    def retranslateUi(self, dConfigurarFechaHora):
        ...
        self.label_Atributo.setText(_translate("dConfigurarFechaHora", "<html><head/><body><p><span style=\" font-size:18pt;\">Fecha (AAAA-MM-DD)<br/></span></p><p><span style=\" font-size:18pt;\">Hora (hh:mm:ss)</span></p><p><br/></p></body></html>", None))
