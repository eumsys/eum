...
class Variable():
    ...
    def establecerValor (self, valor):
        ...
        if self.__interfaz is not None :
            try:
                self.__interfaz(self.__indice, self.__valor)
            except:
                """"""
    ...
    def __str__ (self):
        return ("%s %s %s" % (self.__tag.ljust( 10 ), str(self.__descripcion).rjust( 10 ), str(self.__tipo).rjust( 10 )))
