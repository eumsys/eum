...
def checale(fecha1,fecha2):
	...
	cur.execute("select tarifa,COUNT(\"idBoleto\") from \"BOLETO\" where \"fechaExpedicion\" BETWEEN '"+fecha1+"' and '"+fecha2+"' group by tarifa ")
	for reg in cur: 
		print(reg[0],reg[1])
...
leerArch = open("/home/pi/Documents/fechaTarifas.txt", "r")
sp=leerArch.readline().split(',',2)
fecha1=sp[0]
fecha2=sp[1]
leerArch.close()
leerArch = open("/home/pi/Documents/fechaTarifas.txt", "w")
leerArch.write('')
leerArch.close()
